...
export const COMPOSER_INLINE_SKILL_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-1 rounded-md border border-primary/30 bg-primary/12 px-1.5 py-px font-medium text-[12px] leading-[1.1] text-primary align-middle";
